...
I like to use [Atom](https://atom.io/) as my lightweight editor when I'm doing simple changes and I rely on [Pycharm](https://www.jetbrains.com/lp/pycharm-anaconda/) if I ever wanna build something more robust. Pycharm has great features like merge conflicts and tool-tiping to make sure you remember to do the small but annoying stuff in your code.
...
Brew installs the packages that Mac OS is missing.
...
4. Virtualevn allows you to create virtual environment so that your projects can maintain dependency separation.
